...
class MinimumTest {
	...
	int Minimum_Success(int value) {
		return avltree_.Return_Minimum(value);
	}
...
class MinimumParameterizedTestFixture: public testing::TestWithParam<std::tuple<int,int>> {
	protected:
...
INSTANTIATE_TEST_CASE_P(
	MinimumTests,
	MinimumParameterizedTestFixture,
